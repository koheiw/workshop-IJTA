...
```{r plot1, echo=TRUE, results='asis', fig.height=5, fig.width=8, dpi=100}
...
```
```{r plot2, echo=TRUE, results='asis', fig.height=5, fig.width=8, dpi=100}
...
#### グラフのカスタマイズ
```{r plot3, echo=TRUE, results='asis', fig.height=5, fig.width=8, dpi=100}
plot((mx_trump[,'positive'] - mx_trump[,'negative']) / wordage, type = 'l', 
...
lda_10 <- LDA(convert(mx_front, to = "topicmodels"), k = 10) # 10のトピックを発見する
get_terms(lda_k10, 10) # 最も重要な10語を表示
```
