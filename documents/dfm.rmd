...
```{r plot1, echo=TRUE, results='asis', fig.height=4, fig.width=7, dpi=100}
...
```
```{r plot2, echo=TRUE, results='asis', fig.height=4, fig.width=7, dpi=100}
...
#### グラフのカスタマイズ
```{r plot3, echo=TRUE, results='asis', fig.height=4, fig.width=7, dpi=100}
plot((mx_trump[,'positive'] - mx_trump[,'negative']) / wordage, type = 'l', 
