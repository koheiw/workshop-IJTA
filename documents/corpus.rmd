...
### corpusの保存
```{r save}
save(corp, file = 'data/data_corpus_asahi_head.rda')
...
## corpusの操作
```{r manipulation}
load('data/data_corpus_asahi_2016.rda') # Rオブジェクトの読み込み
...
### 文書の分割
```{r segment}
corp_sent <- corpus_segment(data_corpus_asahi_2016, pattern = "。") # 記事を句点で分割
ndoc(corp_sent)
