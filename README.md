# Rによる日本語のテキスト分析入門
Rによるテキスト分析を始める人のための、日本語による[**quanteda**](https://github.com/kbenoit/quanteda)の使用法の説明。メディア分析を事例とし、サンプルデータは朝日新聞の2016年の政治および外交に関する記事。本稿は、2017年に早稲田大学および神戸大学で開催したワークショップの資料が元になっている。
